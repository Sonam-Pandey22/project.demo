...
class Facial_Recognition_System:
    def __init__(self,root):
       ...
       # Detect face button
        ...
        b1.place(x=400,y=30,width=220,height=220)
       ...
       # Attendance face button
        ...
        b1.place(x=700,y=30,width=220,height=220)
      ...
      # help button
        ...
        b1.place(x=1000,y=30,width=220,height=220)
        ...
        b1.place(x=100,y=280,width=220,height=220)
        ...
        b1.place(x=400,y=280,width=220,height=220)
        ...
        b1.place(x=700,y=280,width=220,height=220)
        ...
        b1.place(x=1000,y=280,width=220,height=220)
